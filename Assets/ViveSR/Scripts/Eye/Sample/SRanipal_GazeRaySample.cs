        ...
        namespace Eye
        {
            public class SRanipal_GazeRaySample : MonoBehaviour
            {
                ...
                private void Update()
                {
                    ...
                    var point1 = Camera.main.transform.position - Camera.main.transform.up * 0.05f;
                    var point2 = Camera.main.transform.position + GazeDirectionCombined * LengthOfRay;
                    GazeRayRenderer.SetPosition(0, point1);
                    GazeRayRenderer.SetPosition(1, Camera.main.transform.position + GazeDirectionCombined * LengthOfRay);
                    Cone.transform.position = point1;
                    Cone.transform.LookAt(point2);
                }
